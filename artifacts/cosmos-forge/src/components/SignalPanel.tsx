      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[90] flex items-start justify-center px-4 pt-8 pb-28"
          ...
          >
            <motion.div
              ...
              className="w-full max-w-[500px] max-h-[calc(100vh-10rem)] overflow-y-auto rounded-2xl p-5"
              style={{
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-5 max-h-[30vh] overflow-y-auto pr-1">
      ...
      <AnimatePresence>
        {resp && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[95] flex items-start justify-center px-4 pt-8 pb-28"
          ...
          >
            <motion.div
              ...
              className="max-w-md w-full mx-4 max-h-[calc(100vh-10rem)] overflow-y-auto rounded-2xl p-6 text-center"
              style={{
